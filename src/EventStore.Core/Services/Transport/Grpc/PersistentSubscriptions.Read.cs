	...
	public partial class PersistentSubscriptions {
		...
		public override async Task Read(IAsyncStreamReader<ReadReq> requestStream,
			...
			switch (options.StreamOptionCase) {
				case ReadReq.Types.Options.StreamOptionOneofCase.Stream:
					streamId = options.Stream.StreamIdentifier;
					break;
				case ReadReq.Types.Options.StreamOptionOneofCase.None: /*for backwards compatibility*/
